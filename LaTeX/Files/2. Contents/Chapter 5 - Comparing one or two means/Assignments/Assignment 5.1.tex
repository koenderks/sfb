...
\hint{You can find the formula for the \concept{z-score} in the formula sheet. Use $\mu_0$ in this formula.}
...
\hint{You can find the formula for the \concept{t-score} in the formula sheet. Use $\mu_0$ in this formula.}
