...
\hint{You can find the formula for a \concept{confidence interval} for a \concept{proportion} in the formula sheet. Use z = 1.960 (see also Table 4 on page~\pageref{table4})}
...
\hint{You can find the formulas for the following assignments in the formula sheet.}
