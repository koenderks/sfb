...
\beginnerexercise{
    What does \rcode{(a < 0 | b < 0) \& (a * b < 0)} mean (| and & are the logical "or" and "and" operator, respectively)? If this condition is \rcode{TRUE} and \rcode{a} is negative, what do you know about \rcode{b}?
}
