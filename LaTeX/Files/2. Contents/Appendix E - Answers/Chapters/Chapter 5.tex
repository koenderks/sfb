...
\answer{
Two-tailed inequality test: \hspace{0.5cm} $H_0$ rejected (2.6 > 2.476) \\
One-tailed right sided test: \hspace{0.3cm} $H_0$ rejected (2.3 > 2.153) \\
One-tailed left sided test: \hspace{0.5cm} $H_0$ not rejected (-1.6 > -2.153) \\
