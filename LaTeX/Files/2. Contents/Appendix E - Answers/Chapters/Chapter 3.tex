...
se1 <- sd1 / sqrt(90)    {\color{dataset} \# Standard error: 29.24} \\
se2 <- sd2 / sqrt(90)    {\color{dataset} \# Standard error: 7.64} \\
se3 <- sd3 / sqrt(90)    {\color{dataset} \# Standard error: 30.61} \\
se4 <- sd4 / sqrt(90)    {\color{dataset} \# Standard error: 18.09}
    }
}
