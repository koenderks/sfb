...
\hint{Check the formula sheet to find out how to calculate $SE_\mu$.}
...
\hint{You can find the formula for the \concept{lower bound}, \concept{upper bound} and \concept{z-value} in the formula sheet.}
