...
\hint{you can find the formula for the \concept{variance} in the formula sheet on page~\pageref{formulasheet}.}
...
\hint{you can find the formula for \concept{Hartley’s F} in the formula sheet on page~\pageref{formulasheet}.}
...
\hint{Check Table 1 on page~\pageref{table1} for the critical values of \concept{Hartley’s F}.}
