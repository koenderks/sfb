...
\handassignment{Creating a histogram by hand}

Suppose that you have the following set of fifteen numbers: \\
...
\emptyanswerbox{
    \vspace*{-0.8cm}
    \begin{center}
    \includegraphics[height = 6.8cm]{Files/Images/emptyHistogram.pdf}
    \end{center}
}
